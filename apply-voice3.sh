...
# ============================================================
#  ChatsSync — voice v3
#      cd /root/staging-build && bash apply-voice3.sh
#
#  FIX 1: send button kaam nahi kar raha tha
#         (emits Options API mein declare nahi the)
#  FIX 2: bheji hui voice ab WhatsApp jaisi —
#         bubble ke andar, play + waveform + duration
# ============================================================
set -e
...
cat > app/javascript/dashboard/assets/scss/app.scss << 'CS_EOF_VOICE3'
@import 'woot';
...
cat > app/javascript/dashboard/components/widgets/conversation/MessagesView.vue << 'CS_EOF_VOICE3'
<script>
...
cat > app/javascript/dashboard/components/widgets/ChatTypeTabs.vue << 'CS_EOF_VOICE3'
<script setup>
...
cat > app/javascript/dashboard/components-next/sidebar/provider.js << 'CS_EOF_VOICE3'
...
cat > app/javascript/dashboard/components/widgets/WootWriter/AudioRecorder.vue << 'CS_EOF_VOICE3'
<script setup>
...
cat > app/javascript/dashboard/components/widgets/WootWriter/ReplyBottomPanel.vue << 'CS_EOF_VOICE3'
<script>
import { ref } from 'vue';
import { useUISettings } from 'dashboard/composables/useUISettings';
import { useKeyboardEvents } from 'dashboard/composables/useKeyboardEvents';
...
cat > app/javascript/dashboard/components/widgets/conversation/ReplyBox.vue << 'CS_EOF_VOICE3'
<script>
...
cat > app/javascript/dashboard/components-next/message/bubbles/Audio.vue << 'CS_EOF_VOICE3'
<script setup>
import { computed } from 'vue';
...
cat > app/javascript/dashboard/components-next/message/chips/Audio.vue << 'CS_EOF_VOICE3'
<script setup>
import {
  computed,
  onMounted,
...
echo "  Test: record -> pause -> resume -> SEND"
echo "  Bheji hui voice bubble ke andar honi chahiye"
echo "============================================"
