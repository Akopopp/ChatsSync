#!/bin/bash
# ============================================================
#  ChatsSync — WhatsApp UI + voice (v2, duplicate attribute fix)
#      cd /root/staging-build && bash apply-voice2.sh
# ============================================================
set -e
...
cat > app/javascript/dashboard/assets/scss/app.scss << 'CS_EOF_VOICE2'
@import 'woot';
...
cat > app/javascript/dashboard/components/widgets/conversation/MessagesView.vue << 'CS_EOF_VOICE2'
<script>
...
cat > app/javascript/dashboard/components/widgets/ChatTypeTabs.vue << 'CS_EOF_VOICE2'
<script setup>
...
cat > app/javascript/dashboard/components-next/sidebar/provider.js << 'CS_EOF_VOICE2'
...
cat > app/javascript/dashboard/components/widgets/WootWriter/AudioRecorder.vue << 'CS_EOF_VOICE2'
<script setup>
...
cat > app/javascript/dashboard/components/widgets/WootWriter/ReplyBottomPanel.vue << 'CS_EOF_VOICE2'
<script>
import { ref } from 'vue';
import { useUISettings } from 'dashboard/composables/useUISettings';
import { useKeyboardEvents } from 'dashboard/composables/useKeyboardEvents';
...
cat > app/javascript/dashboard/components/widgets/conversation/ReplyBox.vue << 'CS_EOF_VOICE2'
<script>
...
echo ""
echo "  Voice test:"
echo "   mic -> record | pause -> RUKE (awaz na aaye)"
echo "   mic -> resume | trash -> gayab | send -> jaye"
echo "============================================"
