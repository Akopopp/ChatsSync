#!/bin/bash
# ============================================================
#  ChatsSync — WhatsApp UI + voice recording theek
#      cd /root/staging-build && bash apply-voice.sh
#
#  AudioRecorder.vue     asli pause/resume (playback nahi), delete,
#                        WhatsApp jaisi patli waveform
#  ReplyBottomPanel.vue  recording patti: delete, red dot, waqt, pause, send
#  ReplyBox.vue          wiring
#  + v17 theme (app.scss, pills, rail, doodle)
# ============================================================
set -e
...
cat > app/javascript/dashboard/assets/scss/app.scss << 'CS_EOF_VOICE1'
@import 'woot';
...
cat > app/javascript/dashboard/components/widgets/conversation/MessagesView.vue << 'CS_EOF_VOICE1'
<script>
...
cat > app/javascript/dashboard/components/widgets/ChatTypeTabs.vue << 'CS_EOF_VOICE1'
<script setup>
...
cat > app/javascript/dashboard/components-next/sidebar/provider.js << 'CS_EOF_VOICE1'
...
cat > app/javascript/dashboard/components/widgets/WootWriter/AudioRecorder.vue << 'CS_EOF_VOICE1'
<script setup>
...
cat > app/javascript/dashboard/components/widgets/WootWriter/ReplyBottomPanel.vue << 'CS_EOF_VOICE1'
<script>
import { ref } from 'vue';
import { useUISettings } from 'dashboard/composables/useUISettings';
import { useKeyboardEvents } from 'dashboard/composables/useKeyboardEvents';
...
cat > app/javascript/dashboard/components/widgets/conversation/ReplyBox.vue << 'CS_EOF_VOICE1'
<script>
...
echo ""
echo "  Voice test:"
echo "   1. mic dabao -> recording shuru"
echo "   2. pause dabao -> RUKNI chahiye, awaz nahi sunni chahiye"
echo "   3. mic dobara -> wahin se resume"
echo "   4. trash -> recording gayab, kuch send nahi"
echo "   5. send -> voice chali jaye"
echo "============================================"
