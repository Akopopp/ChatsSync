#!/bin/bash
# ============================================================
#  ChatsSync — Chats panel dobara likha (WhatsApp)
#      cd /root/staging-build && bash apply-chats-ui.sh
#
#  app.scss             poora WhatsApp theme + doodle
#  MessagesView.vue     dohra doodle hataya
#  ChatTypeTabs.vue     underline tabs -> asli pills
#  ReplyBottomPanel.vue composer WhatsApp tarteeb mein
#                       (📎 😊 | input | mic ya gol hara send)
...
cat > app/javascript/dashboard/assets/scss/app.scss << 'CS_EOF_6h2k9'
@import 'woot';
...
cat > app/javascript/dashboard/components/widgets/conversation/MessagesView.vue << 'CS_EOF_6h2k9'
<script>
...
cat > app/javascript/dashboard/components/widgets/ChatTypeTabs.vue << 'CS_EOF_6h2k9'
<script setup>
...
cat > app/javascript/dashboard/components/widgets/WootWriter/ReplyBottomPanel.vue << 'CS_EOF_6h2k9'
<script>
import { ref } from 'vue';
...
cat > app/javascript/dashboard/components-next/sidebar/provider.js << 'CS_EOF_6h2k9'
