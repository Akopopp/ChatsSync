#!/bin/bash
# ============================================================
#  ChatsSync — WhatsApp UI (complete)
#      cd /root/staging-build && bash apply-wa.sh
#
#  app.scss              18 sections — rail, list, thread, bubbles,
#                        composer, menus, settings, tables, forms,
#                        scrollbars, mobile, accessibility
#  MessagesView.vue      dohra doodle hataya
#  ChatTypeTabs.vue      underline tabs -> asli pills
#  ReplyBottomPanel.vue  composer WhatsApp tarteeb (mic <-> send)
#  provider.js           rail 62px par majboor
# ============================================================
set -e
...
cat > app/javascript/dashboard/assets/scss/app.scss << 'CS_EOF_0p4r7'
@import 'woot';
...
cat > app/javascript/dashboard/components/widgets/conversation/MessagesView.vue << 'CS_EOF_0p4r7'
<script>
...
cat > app/javascript/dashboard/components/widgets/ChatTypeTabs.vue << 'CS_EOF_0p4r7'
<script setup>
...
cat > app/javascript/dashboard/components/widgets/WootWriter/ReplyBottomPanel.vue << 'CS_EOF_0p4r7'
<script>
import { ref } from 'vue';
...
cat > app/javascript/dashboard/components-next/sidebar/provider.js << 'CS_EOF_0p4r7'
...
echo "  Light + dark + mobile teeno check karna"
echo "============================================"
